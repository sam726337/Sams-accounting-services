...
class RandomSalePanel(QWidget):
    ...
    def load_tally_masters(self):
        ...
        cgst_ledgers = self.keyword_ledgers(tax_ledgers, ("cgst", "central tax")) or tax_ledgers
        sgst_ledgers = self.keyword_ledgers(tax_ledgers, ("sgst", "state tax")) or tax_ledgers
